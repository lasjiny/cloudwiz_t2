    ...
    <div class="row">
      ...
      <div class="col-xl-6 text-start">
        <div class="card">
          ...
          <div class="card-body">
            <GoogleMap :center="{ lat: 20.5937, lng: 78.9629 }" :zoom="6" style="width: auto; height: 500px" :options="{
              region: 'VI',
              language: 'vi',
            }">
            </GoogleMap>
...
import Markers from "~/components/t2/maps/maps/markersPage.vue"
import DraggableMarker from "~/components/t2/maps/maps/draggableMarker.vue"
import GooglePolyline from "~/components/t2/maps/maps/polylinePage.vue"
import TrianglePolygon from "~/components/t2/maps/maps/triangle_polyline.vue"
export default {
  components: {
