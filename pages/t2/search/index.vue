...
<script>
import allView from "~/components/t2/search/allView.vue"
import imagesView from "~/components/t2/search/imagesView.vue"
import videoView from "~/components/t2/search/videoView.vue"
export default {
    components: {
