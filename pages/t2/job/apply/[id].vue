...
import { useJobStore } from '~/store/t2/jobs';

import jobtab from "~/components/t2/job/list/jobTab.vue"
import Personal from "~/components/t2/job/apply/personal/personalPage.vue"
import education from "~/components/t2/job/apply/educationPage.vue"
import experience from "~/components/t2/job/apply/experiencePage.vue"
import upload from "~/components/t2/job/apply/uploadPage.vue"
export default {
    components: {
        jobtab,
        Personal,
