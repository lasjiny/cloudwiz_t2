...
import radioField from "~/components/t2/builder/form/radioField.vue"
import inputField from "~/components/t2/builder/form/inputField.vue"
import selectField from "~/components/t2/builder/form/selectField.vue"
import buttonField from "~/components/t2/builder/form/buttonField.vue"
export default {
    inject: ['list'],
    data() {
        return {
