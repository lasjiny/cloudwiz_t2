                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <DropZone class="text-center" :maxFileSize="Number(60000000)"
                                            url="http://localhost:8080" :uploadOnDrop="true" :multipleUpload="true"
                                            :parallelUpload="2" />
                                    </div>
                                </div>
                            </div>
...
import ProjectTitle from "~/components/t2/project/createproject/ProjectTitle.vue"
export default {
    name: 'createProject',
    components: {
        Datepicker1, ProjectTitle
    },
}
</script>
