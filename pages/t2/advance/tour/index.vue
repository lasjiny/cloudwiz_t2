...
<script>
import tourProfile from "~/components/t2/advance/tour/tourProfile.vue";
import tourProfile2 from "~/components/t2/advance/tour/tourProfile2.vue";
import tourProfile3 from "~/components/t2/advance/tourProfile3.vue";
import tourProfile4 from "~/components/t2/advance/tour/tourProfile4.vue";
import tourProfile5 from "~/components/t2/advance/tour/tourProfile5.vue";
export default {
  components: {
    tourProfile,
    tourProfile2,
