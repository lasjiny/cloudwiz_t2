<template>
  <Breadcrumbs title="Blog Details" main="Blog" />
  <div class="container-fluid ">
    <div class="row">
      <div class="col-xl-6 set-col-12 box-col-12">
        <div class="card">
          <div class="blog-box blog-shadow"><img class="img-fluid bg-img-cover" src="/images/blog/blog.jpg" alt="">
...
<script>
import detail from "~/components/t2/blog/details/detailPage.vue"
import detail1 from "~/components/t2/blog/details/detail1Page.vue"
export default {
  components: {
    detail,
    detail1
