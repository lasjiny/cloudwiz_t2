import bookmark from '~/data/t2/bookmark.json';
import projects from '~/data/t2/project.json';
import orederhistory from '~/data/t2/orederhistory.json';
import Knowledgebase from '~/data/t2/Knowledgebase.json';
