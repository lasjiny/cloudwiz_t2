        ...
        <tr>
          <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0">
              <tbody>
                <tr>
                  <td><img src="/images/email-template/delivery.png" alt=""
                           style=";margin-bottom: 30px; border-radius:10px;"></td>
                </tr>
                <tr>
                  <td>
                    <svg class="temp-check" version="1.1" xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 489.327 489.327"
                      style="enable-background:new 0 0 489.327 489.327;" xml:space="preserve">
                      <g>
                        <g>
                          <path
            ...
            <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
              <tbody>
                ...
                <tr v-for="(item, index) in cart" :key="index">
                  <td><img :src="getImgUrl(item.img)" alt="" width="130"></td>
                  <td valign="top" style="padding-left: 15px;">
                    <h5 style="margin-top: 15px;">{{ item.name }} </h5>
                  </td>
                  <td valign="top" style="padding-left: 15px;">
                    <h5 style="font-size: 14px; color:#444;margin-top:15px;    margin-bottom: 0px;">Size : <span>
                        {{ item.size[0] }}</span></h5>
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="left"
              ...
              <tbody>
                <tr>
                  ...
                  <td class="user-info" width="57" height="25"><img src="/images/email-template/space.jpg" alt=" "
            ...
            <table class="main-bg-light text-center" align="center" border="0" cellpadding="0" cellspacing="0"
              width="100%" style=" margin-top:30px; border-radius:10px;">
              <tbody>
                <tr>
                    ...
                    <table class="footer-social-icon" border="0" cellpadding="0" cellspacing="0" align="center"
                      ...
                      <tbody>
                        <tr class="temp-social">
                          ...
                          <td><a href="https://www.youtube.com"><i class="fa fa-youtube-play"></i></a></td>
                          ...
                          <td><a href="https://www.linkedin.com"><i class="fa fa-linkedin"> </i></a></td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td><a href="javascript:void(0)"
                              style="color: #534686;font-size:14px;text-transform: capitalize;font-weight:600;">Want to
                              change how you receive these emails?</a></td>
                        </tr>
                        <tr>
                          <td>
                            <p style="font-size:14px; margin:8px 0; color:#717171;">2022 - 22 Copy Right by Themeforest
                              powerd by Pixel Strap</p>
                          </td>
                        </tr>
                        <tr>
                          <td><a href="javascript:void(0)"
                              style="color: #534686;font-size: 14px;text-transform: capitalize;font-weight:600; margin:0;">Unsubscribe</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
