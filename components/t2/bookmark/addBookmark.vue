...
export default {
    components: {
        notification, newsletter, shared, newBookmark, tagsmodal, createdbyMe, favouritePage, myBookmark, bHoliday, iOrganization
    },
    data() {
        return {
            liststyle: false, favourite: useCommonStore().favourite, filtered: false,
        };
    },
    methods: {
