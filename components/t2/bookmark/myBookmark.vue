<template>
  <div class="fade tab-pane" v-bind:class="(activeclass === 'pills_bookmark') ? 'active show' : ''" id="pills-bookmark"
    role="tabpanel" aria-labelledby="pills-bookmark-tab">
    <div class="card mb-0">
            ...
            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6 xl-50 box-col-6" v-for="(item, index) in bookmark"
              ...
              <div class="card card-with-border bookmark-card o-hidden">
                <div class="details-website">
                  ...
                  <div class="favourite-icon favourite_0"><a href="javascript:void(0)"><i class="fa fa-star"></i></a>
                  </div>
...
import { useCommonStore } from '~/store/t2/common';
import bookmarkMixin from "~/mixin/t2/commen/bookmarkMixin"
export default {
  components: { editBookmark },
  mixins: [bookmarkMixin],
  data() {
    return {
      liststyle: false, data: [], favourite: useCommonStore().favourite, filtered: false,
    };
  },
  computed: {
    ...
    activeclass() { return useCommonStore().activeclass1 }
  },
