  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="profile-img-style">
        ...
        <hr>
        <p>you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in
        ...
        <div class="row mt-4 pictures" id="aniimated-thumbnials-2"><a class="col-sm-6" href="javascript:void(0)"><img
            class="img-fluid rounded" src="/images/other-images/profile-style-img.png" alt="gallery"></a><a
            class="col-sm-6" href="javascript:void(0)"><img class="img-fluid rounded"
                                                            src="/images/other-images/profile-style-img.png" alt="gallery"></a></div>
