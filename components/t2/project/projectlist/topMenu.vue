    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <nuxt-link class="btn btn-primary" to='/project/createproject'>
                    <vue-feather class="me-1" type="plus-square"> </vue-feather>Create New Project
                </nuxt-link>
            </div>
        </div>
    </div>
...
import doingPage from './doingPage.vue'
