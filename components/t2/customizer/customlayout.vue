    ...
    <ul class="sidebar-type layout-grid layout-types">
      ...
      <li data-attr="material-layout horizontal-wrapper">
        <div class="layout-img">
          ...
          "><img src="/images/landing/layout-images/los.jpg" class="img-fluid" alt="one" /></a>
      ...
      <li data-attr="box-layout" class="box-layout">
        <div class="layout-img">
          <a @click="handlePageLayputs('compact-wrapper box-layout', 'NewYork')"><img
              src="/images/landing/layout-images/newyork.jpg" class="img-fluid" alt="one" /></a>
      ...
      <li data-attr="material-icon">
        <div class="layout-img">
          ...
          "><img src="/images/landing/layout-images/romo.jpg" class="img-fluid" alt="one" /></a>
      ...
      <li class="only-body" data-attr="default-body">
        <div class="layout-img">
          <a @click="handlePageLayputs('only-body', 'London')"><img src="/images/landing/layout-images/london.jpg"
              class="img-fluid" alt="one" /></a>
