    ...
    <div class="currency-widget warning height-equal widget-currency">
      <div class="d-flex">
        <div class="currency-icon-widget">
          <svg>
            <use href="@/assets/t2/svg/icon-sprite.svg#beta"></use>
          </svg>
        </div>
        <div>
  ...
  <div class="col-sm-4 col-xxl-2">
    <div class="currency-widget primary height-equal widget-currency">
      <div class="d-flex">
        <div class="currency-icon-widget">
          <svg>
            <use href="@/assets/t2/svg/icon-sprite.svg#eth"></use>
          </svg>
        </div>
        <div>
  ...
  <div class="col-sm-4 col-xxl-2">
    <div class="currency-widget success height-equal widget-currency">
      <div class="d-flex">
        <div class="currency-icon-widget">
          <svg>
            <use href="@/assets/t2/svg/icon-sprite.svg#ltc"></use>
          </svg>
        </div>
        <div>
...
<script>
import { cryptoDashboard } from '~/data/t2/comon'
export default {
  data() {
    return {
