          ...
          <div class="card-body">
            <div class="course-widget">
              <div class="course-icon">
                <svg class="fill-icon">
                  <use href="@/assets/t2/svg/icon-sprite.svg#course-1"></use>
                </svg>
              </div>
              <div>
                <h4 class="mb-0">100+</h4><span class="f-light">Completed Courses</span><a class="btn btn-light f-light"
                  href="learning-list-view.html">View course<span class="ms-2">
                    <svg class="fill-icon f-light">
                      <use href="@/assets/t2/svg/icon-sprite.svg#arrowright"></use>
                    </svg></span></a>
              </div>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="course-widget">
              <div class="course-icon warning">
                <svg class="fill-icon">
                  <use href="@/assets/t2/svg/icon-sprite.svg#course-2"></use>
                </svg>
              </div>
              <div>
